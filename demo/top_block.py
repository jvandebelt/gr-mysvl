...
# Title: Top Block
# Generated: Wed Mar 13 17:13:20 2019
##################################################
...
class top_block(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.gain = gain = 0.264
        self.freq = freq = 3550e6

        ##################################################
        # Blocks
        ##################################################
        self._threshold_range = Range(0, 0.2, 0.0005, 0.05, 200)
        ...
        self._gain_range = Range(0, 1, 0.001, 0.264, 200)
        ...
        self.qtgui_time_sink_x_0_1_0.set_y_axis(-192, 192)
        ...
        self.top_grid_layout.addWidget(self._qtgui_time_sink_x_0_1_0_win, 6,0,1,4)
        self.qtgui_time_sink_x_0_1 = qtgui.time_sink_f(
        	1024, #size
        	samp_rate, #samp_rate
        	"GMSK output bytes", #name
        	1 #number of inputs
        )
        ...
        self.qtgui_time_sink_x_0_0_0 = qtgui.time_sink_f(
        	(preamble_len+packet_len+2*padding), #size
        	samp_rate, #samp_rate
        ...
        self.mysvl_svl_0_0 = mysvl.svl(gr.sizeof_gr_complex*1, 1, "/home/jonathan/Dropbox/repos/gr-mysvl/demo/inputs/maps/demo1b_rx.txt", "/home/jonathan/Dropbox/repos/gr-mysvl/demo/inputs/params/demo1b_rx.txt")
        ...
        self.connect((self.blks2_packet_decoder_0, 0), (self.blocks_char_to_float_0_1, 0))    
        ...
        self.connect((self.digital_ofdm_rx_0, 0), (self.blocks_char_to_float_0_1_0, 0))    
        self.connect((self.digital_ofdm_rx_0, 0), (self.blocks_udp_sink_0, 0))    
        self.connect((self.mysvl_svl_0_0, 1), (self.rational_resampler_xxx_0_0, 0))    
        self.connect((self.mysvl_svl_0_0, 0), (self.rational_resampler_xxx_0_0_0, 0))    
        ...
        self.connect((self.rational_resampler_xxx_0_0_0, 0), (self.digital_gmsk_demod_0, 0))    
