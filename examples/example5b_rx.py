...
# Title: Example5B Rx
# Generated: Mon Mar 11 07:30:35 2019
##################################################
...
class example5b_rx(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.top_grid_layout.addWidget(self._qtgui_time_sink_x_0_0_0_1_win, 3,0,1,1)
        ...
        self.top_grid_layout.addWidget(self._qtgui_time_sink_x_0_0_0_0_win, 2,0,1,1)
        ...
        self.connect((self.mysvl_svl_1, 0), (self.digital_ofdm_rx_0, 0))    
        self.connect((self.mysvl_svl_1, 0), (self.qtgui_time_sink_x_0_0_0_1, 0))    
        self.connect((self.mysvl_sync_channels_0, 0), (self.mysvl_svl_1, 0))    
        self.connect((self.mysvl_sync_channels_0, 1), (self.mysvl_svl_1, 1))    
        self.connect((self.mysvl_sync_channels_0, 0), (self.qtgui_time_sink_x_0_0_0, 0))    
        self.connect((self.mysvl_sync_channels_0, 1), (self.qtgui_time_sink_x_0_0_0_0, 0))    
