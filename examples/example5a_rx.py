...
# Title: Example5A Rx
# Generated: Tue Sep 18 17:54:43 2018
##################################################
...
class example5a_rx(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.blocks_udp_source_0 = blocks.udp_source(gr.sizeof_gr_complex*1, '127.0.0.1', 4000, 1472*16, True)
        ...
        self.connect((self.mysvl_triggered_demux_0, 1), (self.qtgui_time_sink_x_0, 0))
...
def main(top_block_cls=example5a_rx, options=None):
