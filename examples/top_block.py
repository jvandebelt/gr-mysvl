...
# Title: Top Block
# Generated: Tue Mar 12 17:07:20 2019
##################################################
...
class top_block(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.threshold2 = threshold2 = 0.06
        ...
        # Blocks
        ##################################################
        self._threshold2_range = Range(0, 0.1, 0.001, 0.06, 200)
        self._threshold2_win = RangeWidget(self._threshold2_range, self.set_threshold2, "Threshold 2", "counter_slider", float)
        self.top_grid_layout.addWidget(self._threshold2_win, 1,0,1,1)
        self._threshold_range = Range(0, 0.1, 0.001, 0.025, 200)
        self._threshold_win = RangeWidget(self._threshold_range, self.set_threshold, "Threshold 1", "counter_slider", float)
        self.top_grid_layout.addWidget(self._threshold_win, 0,0,1,1)
        ...
        self.uhd_usrp_source_0.set_gain(gain2, 0)
        ...
        self.qtgui_time_sink_x_1 = qtgui.time_sink_f(
        	preamble_len+packet_len+number_len+padding*2, #size
        	samp_rate, #samp_rate
        	"Synchronization", #name
        	4 #number of inputs
        )
        self.qtgui_time_sink_x_1.set_update_time(0.10)
        self.qtgui_time_sink_x_1.set_y_axis(-0.05, 0.1)
        ...
        self.mysvl_triggered_demux_0_0 = mysvl.triggered_demux(gr.sizeof_gr_complex*1, gr.sizeof_float, (packet_len, preamble_len +padding, number_len, padding), 1+padding+preamble_len+number_len, True)
        self.mysvl_triggered_demux_0 = mysvl.triggered_demux(gr.sizeof_gr_complex*1, gr.sizeof_float, (packet_len, preamble_len +padding, number_len, padding), 1+padding+preamble_len+number_len, True)
        self.mysvl_sync_channels_0 = mysvl.sync_channels(packet_len)
        ...
        self.mysvl_drop_packet_0_0 = mysvl.drop_packet(packet_len)
        self.mysvl_drop_packet_0 = mysvl.drop_packet(packet_len)
        ...
        self.analog_const_source_x_0_0 = analog.sig_source_f(0, analog.GR_CONST_WAVE, 0, 0, threshold2)
        ...
        self.connect((self.analog_const_source_x_0_0, 0), (self.qtgui_time_sink_x_1, 3))    
        self.connect((self.blks2_packet_decoder_0_0, 0), (self.blocks_char_to_float_1_0, 0))    
        self.connect((self.blks2_packet_decoder_0_0_0, 0), (self.blocks_char_to_float_1_0_0, 0))    
        ...
        self.connect((self.blocks_abs_xx_1_0, 0), (self.qtgui_time_sink_x_1, 2))    
        self.connect((self.blocks_char_to_float_0, 0), (self.qtgui_time_sink_x_0, 0))    
        self.connect((self.blocks_char_to_float_1_0, 0), (self.mysvl_drop_packet_0_0, 1))    
        self.connect((self.blocks_char_to_float_1_0_0, 0), (self.mysvl_drop_packet_0, 1))    
        ...
        self.connect((self.blocks_tag_gate_0_0_0, 0), (self.digital_ofdm_rx_0, 0))    
        ...
        self.connect((self.digital_gfsk_demod_0, 0), (self.blks2_packet_decoder_0_0_0, 0))    
        ...
        self.connect((self.mysvl_svl_1, 0), (self.blocks_tag_gate_0_0_0, 0))    
        self.connect((self.mysvl_sync_channels_0, 0), (self.mysvl_svl_1, 0))    
        self.connect((self.mysvl_sync_channels_0, 1), (self.mysvl_svl_1, 1))    
        self.connect((self.mysvl_triggered_demux_0, 1), (self.blocks_null_sink_1, 0))    
        self.connect((self.mysvl_triggered_demux_0, 3), (self.blocks_null_sink_1_1, 0))    
        self.connect((self.mysvl_triggered_demux_0, 2), (self.digital_gfsk_demod_0, 0))    
        self.connect((self.mysvl_triggered_demux_0, 0), (self.mysvl_drop_packet_0, 0))    
        self.connect((self.mysvl_triggered_demux_0, 0), (self.qtgui_time_sink_x_2_0, 0))    
        self.connect((self.mysvl_triggered_demux_0_0, 1), (self.blocks_null_sink_1_0, 0))    
        self.connect((self.mysvl_triggered_demux_0_0, 3), (self.blocks_null_sink_1_0_0, 0))    
        self.connect((self.mysvl_triggered_demux_0_0, 2), (self.digital_gfsk_demod_0_0, 0))    
        self.connect((self.mysvl_triggered_demux_0_0, 0), (self.mysvl_drop_packet_0_0, 0))    
        self.connect((self.mysvl_triggered_demux_0_0, 0), (self.qtgui_time_sink_x_2, 0))    
        self.connect((self.uhd_usrp_source_0, 0), (self.digital_corr_est_cc_0_0, 0))    
    ...
    def set_threshold2(self, threshold2):
        ...
        self.analog_const_source_x_0_0.set_offset(self.threshold2)
    ...
    def set_gain2(self, gain2):
        self.gain2 = gain2
        self.uhd_usrp_source_0.set_gain(self.gain2, 0)
